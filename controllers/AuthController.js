...
exports.updatePassword = asyncHandler(async (req, res, next) => {
    ...
    if (!req.body.newPassword || !req.body.currentPassword) return next(new ErrorResponse(`Please provide the current and new password`, 400));
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    if (!user) return next(new ErrorResponse(`User not found with ${req.body.email} email`, 404));
